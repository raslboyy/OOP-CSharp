namespace Shops.Essence.Products
{
    internal class Product
    {
        ...
        public static bool operator ==(Product left, Product right) => ReferenceEquals(left, right) || (!ReferenceEquals(left, null) && left.Equals(right));
